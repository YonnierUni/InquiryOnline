<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IniciarSesion.aspx.cs" Inherits="IO.Vistas.IniciarSesion" %>
...
<body>
    <form id="form1" runat="server">
      ...
      <div class="divbarra">
        ...
        <div class="botones">
          <a href="../Vistas/IniciarSesion.aspx"><input runat="server" type="button" value="Acceder"></a>
          <a href="../Vistas/Registro.aspx"><input runat="server" type="button" value="Comenzar"></a>
        </div>
      </div>
    </header>
    ...
    <div class="container">
      <div class="texto">
        ...
        <div class="inf">
          ...
          <a href="../Vistas/Registro.aspx">Registrarse</a><br>
